...
// this script also helps the player to send deta and receive game data(events) over the network
// this script is used for moving from one scene to another
...
public class PlayerInfo
{
    ...
    public PlayerInfo(string _name, int _actor, int _kills, int _deaths)  // creating constructor
    {
        name = _name;
        actor = _actor;
        kills = _kills;
